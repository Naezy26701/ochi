...
function Footer() {
  return (
    <div className="w-full h-screen flex items-center justify-between bg-zinc-900 p-20 font-['Founders Grotesk Condensed']">
      ...
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          ...
          <div className="dets font-['Neue Montreal'] mt-10">
                <a className="block text-xl font-light mb-3" href="#">Facebook</a>
                <a className="block text-xl font-light mb-3" href="#">Instagram</a>
                <a className="block text-xl font-light mb-3" href="#">Twitter</a>
            </div>
            <div className="copyright mt-[42vh]">
                <h1>&copy;Ochi design 2024. Legal Terms</h1>
            </div>
        </div>
      </div>
    </div>
