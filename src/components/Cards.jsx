    ...
    <div className="w-full h-screen  bg-zinc-800 flex items-center px-32 gap-5">
      <div className="cardcontainer h-[50vh] w-1/2">
        <div className="card relative rounded-xl w-full h-full flex items-center justify-center bg-[#004D43]">
          ...
          <button className="absolute left-10 bottom-10 px-5 py-1 rounded-full border-2 text-sm">&copy;2024-2025</button>
        </div>
      </div>

      <div className="cardcontainer flex gap-5 h-[50vh] w-1/2">
        <div className="card relative rounded-xl w-1/2 h-full flex items-center justify-center bg-zinc-900">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="119"
            height="63"
          ...
          <button className="absolute left-10 bottom-10 px-5 py-1 text-sm rounded-full border-2">RATING 5.0 ON CLUTCH</button>
        </div>

        <div className="card relative rounded-xl w-1/2 h-full flex items-center justify-center bg-zinc-900">
          <img src="src\assets\logo003.png" alt="" />
          <button className="absolute left-10 bottom-10 px-5 py-1 text-sm rounded-full border-2">BUSINESS BOOTCAMP ALUMINI</button>
        </div>
      </div>
    </div>
  );
