...
function Navbar() {
  return (
    <div className='fixed z-[999] w-full flex justify-between items-center px-20 py-8 font-["Neue Montreal"]'>
      <div className='logo'>
      <svg xmlns="http://www.w3.org/2000/svg"
       width="101" height="42" fill="none">
        <path 
      ...
      <div className="links flex gap-10">
        {["Services", "Our Work", "About Us", "Insights", "Contact"].map((item, index)=>(
          <a className={`text-lg capitalize font-light ${index === 4 && "ml-32"}`}>{item}</a>
        ))}
      </div>
    </div>
  )
